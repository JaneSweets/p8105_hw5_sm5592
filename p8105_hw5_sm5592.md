...
sim_results_df =
  ...
  mutate(test_result = map(n, t_test_tidy, mu = mu, sigma = sigma)) |> 
  unnest(test_result)
...
```
    ...
    ## # A tibble: 6 × 6
    ##       n    mu sigma  iter estimate p.value
    ##   <dbl> <dbl> <dbl> <int>    <dbl>   <dbl>
    ## 1    30     0     5     1   -0.512   0.569
    ## 2    30     0     5     2    0.990   0.413
    ## 3    30     0     5     3   -0.864   0.323
    ## 4    30     0     5     4   -0.294   0.760
    ## 5    30     0     5     5    0.803   0.361
    ## 6    30     0     5     6   -0.524   0.590
